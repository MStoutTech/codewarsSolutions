...
function findEvenIndex(arr) {
  //Code goes here!
  return arr.findIndex((num, index, array) => array.slice(0, index).reduce((accumulator, current)=> accumulator + current, 0) === array.slice(index+1, array.length).reduce((accumulator, current)=> accumulator + current, 0) ? true : false);
